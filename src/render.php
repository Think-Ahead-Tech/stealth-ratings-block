...
>
	<h3>
		<?php esc_html_e('Rate Your Experience', 'stealth-ratings-block'); ?>
	</h3>
	<p>
		<?php esc_html_e('How would you rate your experience with', 'stealth-ratings-block'); ?> <?php echo $business_name; ?>?
	</p>
	...
	<form class="stealth-ratings-form" style="display:none; margin-top:1.5rem;">
		<p>
			<?php esc_html_e('Thank you for your rating. We\'d love to hear how we can improve.', 'stealth-ratings-block'); ?>
		</p>
		<label>
